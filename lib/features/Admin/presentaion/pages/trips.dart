  ...
  void _updateFilteredTours(String searchQuery) {
    ...
    if (searchQuery.isNotEmpty) {
      _filteredTours = _tours.where((tour) {
        return tour.line.name!.toLowerCase().contains(searchQuery.toLowerCase()) ||
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return BusCard(
                            ...
                            departureTime: DateFormat('HH:mm').format(tour.leavesAt),
                            date: DateFormat('yyyy/MM/dd').format(tour.leavesAt),
                            isExpanded: expandedIndex == index,
                            onTap: () => _showTripOptionsDialog(context, tourId, tour),
                            onCancel: () => setState(() => expandedIndex = null),
                            onNext: () {},
                          );
                        },
                      );
