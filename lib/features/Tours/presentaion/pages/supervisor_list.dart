                  ...
                  children: [
                    IndexedStack(
                      ...
                      children: [
                        _buildHomeContent(),
                        const TripsScreen(),
                        const Center(child: Text('قائمة المشرفين')),
                      ],
                    ),
                    _buildBottomNav(),
                  ],
        ...
        children: [
          Expanded(
            child: ElevatedButton(
              onPressed: () {
                Navigator.pop(context); // يرجع لصفحة الطلاب
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.grey.shade300,
              ),
              child: const Text('الطلاب', style: TextStyle(color: Colors.black)),
            ),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: ElevatedButton(
              onPressed: () {}, // الصفحة الحالية
              style: ElevatedButton.styleFrom(
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return _buildSupervisorCard(index);
        },
      ),
    );
  }
        ...
        child: ClipRRect(
          ...
          child: BottomNavigationBar(
            ...
            items: const [
              ...
              BottomNavigationBarItem(icon: Icon(Icons.list_outlined), label: 'قائمة المشرفين'),
            ],
          ),
        ),
      ),
